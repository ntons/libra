...
var (
	...
	dbGiftCollectionMu     sync.Mutex
	dbGiftCodeCollectionMu sync.Mutex
	...
	dbGiftCollection     = make(map[string]*mongo.Collection)
	dbGiftCodeCollection = make(map[string]*mongo.Collection)
